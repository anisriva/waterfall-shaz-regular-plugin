...
export interface WaterfallShazRegularPluginStylesProps {
  height: number;
  width: number;
...
export type WaterfallShazRegularPluginQueryFormData = QueryFormData &
  WaterfallShazRegularPluginStylesProps &
